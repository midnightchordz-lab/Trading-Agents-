...
const styles = StyleSheet.create({
  ...
  bulletRow: { flexDirection: "row", marginBottom: spacing.xs, paddingEnd: spacing.sm },
  bulletDot: { fontFamily: fonts.displayReg, fontSize: 13, color: colors.onSurfaceTertiary, marginEnd: 6 },
